...
getupvalue = (debug and debug.getupvalue) or globalenv.getupvalue or globalenv.getupval
getconstant = (debug and debug.getconstant) or globalenv.getconstant or globalenv.getconst
...
getmaxupvalue = function(x, t)
    for _, v in next, t do x = getupvalue(x, v) end
    return x
end
